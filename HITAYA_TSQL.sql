...
CREATE TABLE ADMIN(
	[ADMINID] INT IDENTITY(5000,1),
	[NAME] VARCHAR(20) NOT NULL,
	[EMAILID] VARCHAR(20)  CONSTRAINT pk_EmailId_Admin PRIMARY KEY,
	[PASSWORD] VARCHAR(20) NOT NULL,
	[CRYPTO_ID] VARCHAR(200) NOT NULL,

)

INSERT INTO ADMIN VALUES('Jitendra Data','jdata2010!gmail.com','qwerty123','0xdasdadefcdfmvbbvbvbcmjdjemrfsfrefasf')
